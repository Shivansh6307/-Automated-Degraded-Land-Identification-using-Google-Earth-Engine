...
✅ Features
- **Multi-sensor:** Sentinel-2 SR + Landsat 9 L2
- **Spectral Indices:** NDVI, BSI, SAVI, EVI, NDWI
- **LST:** Land Surface Temperature from Landsat 9
- **ML Classification:** Random Forest (50 trees)
- **Auto Labeling:** Rule-based pseudo-label generation
- **Change Detection:** NDVI & BSI change from baseline (2018–19)
- **Accuracy Assessment:** Confusion matrix + Kappa coefficient
- **Exports:** GeoTIFFs to Google Drive
- **Interactive Map:** geemap visualization
...
| 1 | Mild | NDVI < 0.3 & BSI > 0.002 |
| 2 | Moderate | NDVI < 0.2 & BSI > 0.053 |
